(function($) {
    var CarouselEvo = function(element, options) {
        ...
        var initShortDesc = function() {
            var o = settings;
            for (var i = 0; i < numberSlides; i++) {
                slideItems.eq(i).children('.short-description').hide();
            }
            if (o.short_description == true) {
                slideItems.eq(currentSlide).children('.short-description').show();
            }
        };
        var hideShortDesc = function(index) {
            var o = settings;
            if (o.short_description == true) {
                slideItems.eq(currentSlide).children('.short-description').hide();
            }
        };
        var showShortDesc = function(index) {
            var o = settings;
            setTimeout(function() {
                if (o.short_description == true) {
                    slideItems.eq(currentSlide).children('.short-description').show();
