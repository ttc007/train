...
class MultiUploadAdmin(admin.ModelAdmin):
    class Media:
        js = (
            'assets/multiupload/jquery/jquery.1.8.0.min.js',
            'assets/multiupload/jquery/jquery_fix_csrf.js',
            'assets/multiupload/jquery/jquery.ui.widget.js',
            'assets/multiupload/jquery/tmpl.min.js',
            'assets/multiupload/jquery/canvas-to-blob.min.js',
            'assets/multiupload/jquery/load-image.min.js',
            'assets/multiupload/jquery/jquery.iframe-transport.js',
            'assets/multiupload/jquery/jquery.fileupload.js',
            'assets/multiupload/jquery/jquery.fileupload-fp.js',
            'assets/multiupload/jquery/jquery.fileupload-ui.js',
        )
        css = {
            'all': ['assets/multiupload/css/jquery-ui.css',
                    'assets/multiupload/css/jquery.fileupload-ui.css',
                    'assets/multiupload/css/multiupload.css',
                    ],
        }
